...
function Cart() {
  ...
  useEffect(() => {
    if (!redirectTarget && cartObjects.length === 0 && !showThankYou) {
      navigate('/veg');
    }
  }, [cartObjects.length, redirectTarget, showThankYou, navigate]);
            ...
            {paymentMethod === 'card' && (
              <div className="card-section">
                ...
                >
                  ...
                  <div><label>Cardholder Name:</label><input type="text" placeholder="Your Name" required /></div>
